...
public class Boleto implements Serializable {
    ...
    protected String instrucoesAoPagador = "";

    protected Boleto() {
    }

    /**
     * @return novo Boleto com valores default de especieMoeda R$, código de
     * espécie moeda 9 (real), aceite false e espécie DV
     */
    ...
    /**
     * @param valor em double que após ser convertido pra String será associado
     * ao boleto @see Boleto#comValorBoleto(String)
     *
     * @return this
     */
    ...
    /**
     * @param valor String que é convertido para BigDecimal com o Locale da JVM
     ...
     * @throws UnsupportedOperationException caso a lista de descrições tenha 5
     * descrições
     * @return este boleto
     */
    ...
    /**
     * @param locaisDePagamento que serão associados ao boleto (limite de 2
     * locais)
    ...
    /**
     * @return fator de vencimento do boleto. Utilizado para geração do código
     * de barras
     */
    ...
    /**
     * @param instrucoesAoPagador ao pagador que serão associadas ao boleto
     * (limite de 5)
     * @throws IllegalArgumentException caso tenha mais de 5 instruções
     * @return este boleto
     */
    public Boleto comInstrucoesAoPagador(String... instrucoesAoPagador) {
        for (String str : Arrays.asList(instrucoesAoPagador)) {
            this.instrucoesAoPagador = this.instrucoesAoPagador.concat(str);
        }

        return this;
    }

    public String getInstrucoesAoPagador() {
        return instrucoesAoPagador;
    }
